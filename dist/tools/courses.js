...
export class CoursesTools {
    ...
    async listCourses(params) {
        try {
            ...
            const courses = await this.client.getAllPages('/courses', queryParams);
    ...
    async getCourse(params) {
        try {
            ...
            const response = await this.client.get(`/courses/${params.course_id}`, queryParams);
    ...
    async getCourseModules(params) {
        try {
            ...
            const modules = await this.client.getAllPages(`/courses/${params.course_id}/modules`, queryParams);
