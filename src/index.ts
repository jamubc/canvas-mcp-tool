...
import { AssignmentsTools, ListAssignmentsSchema, GetAssignmentSchema, SubmitAssignmentSchema } from "./tools/assignments.js";
  ...
  try {
    ...
    if (error instanceof CanvasAPIError) {
      throw new McpError(
        ...
        `Canvas API error (${error.statusCode}): ${error.message}`
      );
    }
